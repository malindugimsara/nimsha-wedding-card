...
export const EventDetails = () => {
  ...
  return (
    <section id="events" className="relative py-24 bg-gradient-radial">
        ...
        <div className="flex justify-center">
          {events.map((ev, i) => (
            ...
            >
              ...
              <h3 className="font-script text-4xl md:text-5xl text-gold-gradient mb-6">
          ...
          <div className="glass-card rounded-2xl p-6 flex items-center gap-4 w-full sm:max-w-md">
            ...
            <div>
              ...
              <div className="font-serif">
                {wedding.contact.name} · {wedding.contact.phone}
              </div>
            </div>
          </div>
        </div>
