...
export const Footer = () => {
  ...
  return (
    <footer className="relative py-8 lg:py-16 bg-gradient-soft border-t border-primary/20">
      <div className="container text-center">
        <Ornament className="text-primary w-48 mx-auto mb-6" />
        <h3 className="font-script text-5xl md:text-6xl text-gold-gradient py-2 px-2">
        ...
        <div className="flex justify-center gap-3 mt-4 lg:mt-8">
          ...
          <a href="https://www.facebook.com/profile.php?id=61589021800561" target="_blank" aria-label="Facebook" className="w-11 h-11 grid place-items-center rounded-full glass-card hover:bg-gold-gradient hover:text-primary-foreground transition-all hover:scale-110">
            <FaFacebookF />
          </a>
        </div>
